const quizData = [
    {
        ...
        question: 'ΠΟΙΟ ΕΙΝΑΙ ΤΟ ΠΡΩΤΟ ΔΩΡΟ ΑΠΟ ΤΟΝ ΓΙΩΡΓΟ ΣΤΗΝ ΣΟΦΙΑ;',
        a: 'ΚΑΛΤΣΕΣ',
        b: 'ΔΑΧΤΥΛΙΔΗ',
        c: 'ΧΑΝΤΟΥΚΕΝ',
        d: 'ΚΟΛΙΕ',
        ...
        question: 'ΠΟΥ ΕΚΑΝΕ ΤΟ ΠΡΩΤΟ ΤΗΣ ΜΠΑΝΙΟ Η ΣΟΦΙΑ;',
        a: 'ΠΟΤΙΔΕΑ',
        b: 'ΝΙΚΗΤΗ',
        c: 'DUTZENDEICH',
        d: 'ΜΑΥΡΗ ΘΑΛΑΣΣΑ',
        ...
        question: 'ΠΟΥ ΕΚΑΝΕ ΤΟ ΠΡΩΤΟ ΤΗΣ ΜΠΑΝΙΟ Η ΕΥΑΓΓΕΛΙΑ;',
        a: 'ΜΥΚΟΝΟ',
        b: 'ΧΑΛΚΙΔΙΚΗ',
        c: 'DUTZENDEICH',
        d: 'ΚΕΡΚΥΡΑ',
        ...
        question: 'ΠΟΥ ΕΚΑΝΕ ΤΟ ΠΡΩΤΟ ΤΗΣ ΜΠΑΝΙΟ Η ΜΑΡΙΑ;',
        a: 'ΝΙΚΗΤΗ',
        b: 'ΚΑΛΛΙΚΡΑΤΕΙΑ',
        c: 'ΠΟΛΥΧΡΟΝΟ',
        d: 'ΣΑΡΤΗ',
